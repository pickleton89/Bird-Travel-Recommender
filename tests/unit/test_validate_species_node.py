...
class TestValidateSpeciesNode:
    ...
    def test_direct_common_name_validation(self, validate_node, mock_ebird_api):
        ...
        shared = {"input": {"species_list": ["Northern Cardinal", "Blue Jay"]}}
    ...
    def test_scientific_name_validation(self, validate_node, mock_ebird_api):
        ...
        shared = {
            "input": {"species_list": ["Cardinalis cardinalis", "Cyanocitta cristata"]}
        }
    ...
    def test_species_code_validation(self, validate_node, mock_ebird_api):
        ...
        shared = {"input": {"species_list": ["norcar", "blujay", "amerob"]}}
    ...
    def test_partial_matching(self, validate_node, mock_ebird_api):
        ...
        shared = {"input": {"species_list": ["cardinal", "jay", "robin"]}}
        ...
        for species in shared["validated_species"]:
            assert species["validation_method"] in [
                "partial_common_name",
                "partial_scientific_name",
            ]
    ...
    def test_validation_statistics(self, validate_node, mock_ebird_api):
        ...
        shared = {
            "input": {"species_list": ["Northern Cardinal", "invalid name", "Blue Jay"]}
        }
        ...
        successfully_validated = (
            stats["direct_taxonomy_matches"] + stats["llm_fuzzy_matches"]
        )
    ...
    def test_llm_fallback_integration(self, mock_llm, validate_node, mock_ebird_api):
        ...
        shared = {
            "input": {
                "species_list": [
                    "cardina"
                ]  # Partial name that should trigger LLM fallback
            }
        }
    ...
    @pytest.mark.unit
    @pytest.mark.mock
    def test_validation_methods_parametrized(
        self, validate_node, mock_ebird_api, species_input, expected_method
    ):
        """Test different validation methods using parametrized testing."""
        shared = {"input": {"species_list": species_input}}
