...
def test_validate_species_node():
    ...
    for i, species_list in enumerate(test_species_lists, 1):
        ...
        shared = {"input": {"species_list": species_list}}
        ...
        try:
            ...
            for species in shared["validated_species"]:
                ...
                print(
                    f"    Code: {species['species_code']}, Method: {species['validation_method']}"
                )
                print(
                    f"    Confidence: {species['confidence']}, Scientific: {species['scientific_name']}"
                )
