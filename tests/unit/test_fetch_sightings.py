    ...
    for i, scenario in enumerate(test_scenarios, 1):
        ...
        try:
            ...
            for species in shared['validated_species']:
                print(f"    • {species['original_name']} → {species['common_name']} ({species['species_code']})")
            ...
            print(f"  Fetch methods used: {shared['fetch_stats']['fetch_method_stats']}")
            ...
            if shared['all_sightings']:
                ...
                for j, sighting in enumerate(shared['all_sightings'][:3]):
                    ...
                    print(f"     Validation: {sighting.get('validation_method', 'Unknown')} (confidence: {sighting.get('validation_confidence', 0)})")
