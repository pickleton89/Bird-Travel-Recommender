...
class EndpointTester:
        ...
        try:
            ...
            if result:
                ...
                self.assert_test(
                    ...
                    "Response contains coordinates"
                )
                self.assert_test(
                    "obsDate" in obs,
                    "Response contains observation date"
                )
            ...
            self.assert_test(
                isinstance(result, list),
                "Handles parameter limits correctly"
            )
    ...
    def test_region_info(self, quick: bool = False):
        ...
        try:
            ...
            self.assert_test(
                ...
                "Returns dictionary for region info"
            )
            self.assert_test(
    ...
    def test_hotspot_info(self, quick: bool = False):
        ...
        try:
            ...
            self.assert_test(
                isinstance(result, dict),
                "Returns dictionary for hotspot info"
            )
            self.assert_test(
            ...
            self.assert_test(
                isinstance(result["lat"], (int, float)) and isinstance(result["lng"], (int, float)),
    ...
    def test_performance(self):
        ...
        try:
            ...
            endpoints = [
                ...
                ("get_nearest_observations", lambda: self.client.get_nearest_observations("norcar", 42.36, -71.09))
            ]
...
def main():
    ...
    parser.add_argument("--nearest-observations", action="store_true", help="Test get_nearest_observations only")
    parser.add_argument("--species-list", action="store_true", help="Test get_species_list only")
    parser.add_argument("--region-info", action="store_true", help="Test get_region_info only")
    parser.add_argument("--hotspot-info", action="store_true", help="Test get_hotspot_info only")
