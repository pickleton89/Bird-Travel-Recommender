...
def show_diff(existing: Dict[str, Any], merged: Dict[str, Any], new_config: Dict[str, Any]) -> None:
...
def main():
    ...
    parser.add_argument('--target', type=str,
                        default=os.path.expanduser('~/Library/Application Support/Claude/claude_desktop_config.json'),
    ...
    if 'mcpServers' in new_config and 'bird-travel-recommender' in new_config['mcpServers']:
