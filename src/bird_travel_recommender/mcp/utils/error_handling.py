...
class ValidationError(MCPError):
    ...
    def __init__(self, message: str, field: str, value: Any):
        super().__init__(message, ErrorCategory.VALIDATION_ERROR, {"field": field, "value": value})
        self.field = field
        self.value = value
...
class APIError(MCPError):
    ...
    def __init__(self, message: str, status_code: Optional[int] = None, endpoint: Optional[str] = None):
        super().__init__(message, ErrorCategory.API_ERROR, {"status_code": status_code, "endpoint": endpoint})
...
class RateLimitError(MCPError):
    ...
    def __init__(self, message: str, retry_after: Optional[int] = None):
        super().__init__(message, ErrorCategory.RATE_LIMIT_ERROR, {"retry_after": retry_after})
...
def with_retry(max_retries: int = 3, delay: float = 1.0, backoff_factor: float = 2.0) -> Callable:
...
def with_circuit_breaker(circuit_breaker: CircuitBreaker = ebird_circuit_breaker) -> Callable:
