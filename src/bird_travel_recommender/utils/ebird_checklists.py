"""
eBird API client for checklist and user-related endpoints.

This module provides methods for retrieving checklist data and user statistics from the eBird API,
...
class EBirdChecklistsMixin:
    """Mixin class providing checklist and user-related eBird API methods."""
    ...
    def get_checklist_details(self, checklist_id: str) -> Dict[str, Any]:
        """
...
class EBirdChecklistsClient(EBirdBaseClient, EBirdChecklistsMixin):
    """Complete eBird API client for checklist and user-related endpoints."""
