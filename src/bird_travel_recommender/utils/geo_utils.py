...
def calculate_travel_time_estimate(
    distance_km: float, avg_speed_kmh: float = 60.0
) -> float:
    """
...
if __name__ == "__main__":
    ...
    logger.info(
        f"Valid coordinates (42.36, -71.06): {validate_coordinates(42.36, -71.06)}"
    )
    ...
    within = is_within_radius(
        boston_lat, boston_lng, cambridge_lat, cambridge_lng, 10.0
    )
